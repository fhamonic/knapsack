function(set_project_optimizations project_name)
    set(MSVC_OPTIMIZATIONS /LTCG # link time optimization
    )
    set(CLANG_OPTIMIZATIONS -flto # link time optimization
    )
    set(GCC_OPTIMIZATIONS -flto # link time optimization
    )
